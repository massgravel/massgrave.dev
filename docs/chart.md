...
|                                                                             | HWID | Ohook | Online KMS | ZeroCID[^1] | StaticCID[^1] | KMS4k[^1] |
| --------------------------------------------------------------------------- | :--: | :---: | :--------: | :---------: | :-----------: | :-------: |
| Works offline                                                               |  ❌  |  ✅   |     ❌     |     ✅      |      ❌       |    ✅     |
| Activation is permanent                                                     |  ✅  |  ✅   |   ✅[^3]   |     ✅      |      ✅       |  ✅[^4]   |
| Does not leave any files in the <br /> system to maintain activation status |  ✅  |  ❌   |     ❌     |     ✅      |      ✅       |    ✅     |
...
| Persists between clean installations on the <br /> same hardware |  ✅  |  ❌   |     ❌     |     ❌      |      ❌       |    ❌     |
...
| Windows 8 / 8.1                   |  ❌  |  ❌   |   ✅[^5]   |     ✅      |      ✅       |   ✅[^5]    |
| Windows 10 / 11                   |  ✅  |  ❌   |   ✅[^5]   |     ✅      |      ✅       |   ✅[^5]    |
| Windows 11 (26100.4188 and later) |  ✅  |  ❌   |   ✅[^5]   |     ❌      |      ✅       |   ✅[^5]    |
