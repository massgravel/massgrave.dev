...
:::info
KMS38 activation is only supported on Windows 10/11 Client and Server editions. For more information, please refer to [this page](kms38#supported-products).
:::
